...
module.exports = {
    name: 'command-permissions-remove',
    ...
    options: [
        ...
        {
            name: 'role',
            description: 'The role who may no longer use the command.',
            required: true,
    ...
    callback: (client, interaction) => {
        try {
             ...
             if (file.commandPermissions[commandName].includes(allowRoleId)) {
                const index = file.commandPermissions[commandName].indexOf(allowRoleId);
                file.commandPermissions[commandName].splice(index, 1);
             }
